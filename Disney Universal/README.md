...
| Disney hotel — **target split: AKV savanna Jan 26–28 + Polynesian studio Jan 28–30.** DVC Rental Store won't hold requests for unavailable inventory (8/26: member waitlists absorb cancellations; they declined standing requests) — $100 deposit refunded; when the watcher fires, submit a FRESH request form immediately (speed is everything; lost the 8/24 race in <24h). Watcher hunts studios + savanna 1BRs + scarce 1BRs; **book-anytime full-block fallbacks (all 4 nights, as of 8/26): OKW 1BR $2,185 · SSR 1BR $2,323 · Riviera 1BR $3,243** — tracked as reference rooms, daily check alerts if they start disappearing. ~Nov 1: pick a fallback (CBR cash ~refundable, or one of the 1BR blocks) if the hunt hasn't landed | Bot running; watch email; decide Nov 1 | ☐ |
